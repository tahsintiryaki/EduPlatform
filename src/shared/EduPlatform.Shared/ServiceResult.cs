...
public class ServiceResult<T> : ServiceResult
{
    ...
    public static new ServiceResult<T> Error(ProblemDetails problemDetails, HttpStatusCode status)
    {
        return new ServiceResult<T>
        {
            Status = status,
    ...
    public static new ServiceResult<T> Error(string title, string description, HttpStatusCode status)
    {
        return new ServiceResult<T>
        {
            Status = status,
    ...
    public static new ServiceResult<T> Error(string title, HttpStatusCode status)
    {
        return new ServiceResult<T>
        {
            Status = status,
    ...
    {
        //refit genelde ex.contenti doldur ama bazen doldurmaya biliyor.
        if (string.IsNullOrEmpty(exception.Content))
            return new ServiceResult<T>
            {
                Fail = new ProblemDetails
